...
from ._graphics_setup import get_stone_images, get_scaled_margin
...
def mass_paste_annotation(
    ...
    below_image = Image.alpha_composite(board_image, stones_image)
    for point in points:
        show_x = point[0] - start_point[0]
        show_y = point[1] - start_point[1]
        bbox = _clear_cell(annotations_image, below_image, cell_size, show_x, show_y)
